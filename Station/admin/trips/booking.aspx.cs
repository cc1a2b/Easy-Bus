    ...
    public partial class booking : ConnDB
    {
        ...
        protected void btnUpdate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                var obj = db.tbl_Booking.Where(x => x.Id == elementId).FirstOrDefault();
                ddlStatus.SelectedValue = obj.BookStatus.ToString();
            }
            catch (Exception ex)
            {
        ...
        protected void UpdateData()
        {
            try
            {
                ...
                var obj = db.tbl_Booking.Where(x => x.Id == objId).FirstOrDefault();
                obj.BookStatus = Convert.ToInt32(ddlStatus.SelectedValue);
                db.Entry(obj);
                db.SaveChanges();
