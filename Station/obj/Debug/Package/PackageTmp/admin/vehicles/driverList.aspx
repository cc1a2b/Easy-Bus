<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="driverList.aspx.cs" Inherits="Station.admin.vehicles.driverList" %>

<%@ Register Src="~/admin/vehicles/vehicleUserControl.ascx" TagPrefix="uc" TagName="vehicle" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <%=(Master as adminmaster_master).UserSetting.rm.GetString("Drivers",(Master as adminmaster_master).UserSetting.ci) %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="header">
                    <h5><%=(Master as adminmaster_master).UserSetting.rm.GetString("Drivers",(Master as adminmaster_master).UserSetting.ci) %></h5>
                            ...
                            <asp:ListView ID="lvData" runat="server">
                                <ItemTemplate>
                                    <tr>
                                        ...
                                        <td><%# Eval("DriverIdNum") %></td>
                                        <td><%# Eval("DriverMobile") %></td>
                                        <td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal style-form">
                                <div class="form-group">
                                    ...
                                    <div class="col-lg-6">
                                        <label class="control-label"><%=(Master as adminmaster_master).UserSetting.rm.GetString("ID Number",(Master as adminmaster_master).UserSetting.ci) %></label>
                                        <asp:TextBox ID="txtIDNum" runat="server" class="form-control" placeholder="الهوية" autofocus="on" AutoCompleteType="Disabled"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-lg-6">
