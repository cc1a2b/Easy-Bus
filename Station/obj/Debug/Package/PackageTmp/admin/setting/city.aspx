<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="city.aspx.cs" Inherits="Station.admin.setting.city" %>

<%@ Register Src="~/admin/setting/SettingUserControl.ascx" TagPrefix="uc" TagName="setting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <%=(Master as adminmaster_master).UserSetting.rm.GetString("Cities",(Master as adminmaster_master).UserSetting.ci) %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="header">
                    <h5><%=(Master as adminmaster_master).UserSetting.rm.GetString("Cities",(Master as adminmaster_master).UserSetting.ci) %></h5>
                            ...
                            <div class="form-horizontal style-form">
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="المدينة" autofocus="on" AutoCompleteType="Disabled"></asp:TextBox>
