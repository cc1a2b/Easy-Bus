<%@ Page Title="" Language="C#" MasterPageFile="~/adminMaster.Master" AutoEventWireup="true" CodeBehind="stations.aspx.cs" Inherits="Station.admin.setting.stations" %>

<%@ Register Src="~/admin/setting/SettingUserControl.ascx" TagPrefix="uc" TagName="setting" %>

<asp:Content ID="Content1" ContentPlaceHolderID="title" runat="server">
    <%=(Master as adminmaster_master).UserSetting.rm.GetString("Stations",(Master as adminmaster_master).UserSetting.ci) %>
</asp:Content>
...
<asp:Content ID="Content3" ContentPlaceHolderID="body" runat="server">
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                <div class="header">
                    <h5><%=(Master as adminmaster_master).UserSetting.rm.GetString("Stations",(Master as adminmaster_master).UserSetting.ci) %></h5>
                ...
                <div class="content table-responsive table-full-width">
                    <table class="table table-striped">
                        <thead>
                            <tr>
                                <td><%=(Master as adminmaster_master).UserSetting.rm.GetString("Station",(Master as adminmaster_master).UserSetting.ci) %></td>
                                <td><%=(Master as adminmaster_master).UserSetting.rm.GetString("Address",(Master as adminmaster_master).UserSetting.ci) %></td>
                                <td><%=(Master as adminmaster_master).UserSetting.rm.GetString("City",(Master as adminmaster_master).UserSetting.ci) %></td>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-horizontal style-form">
                                <div class="form-group">
                                    <div class="col-lg-6">
                                        <label class="control-label"><%=(Master as adminmaster_master).UserSetting.rm.GetString("City",(Master as adminmaster_master).UserSetting.ci) %> (*)</label>
                                        <asp:DropDownList ID="ddlCity" runat="server" class="form-control" AppendDataBoundItems="true">
                                            <asp:ListItem Value="-1">...إختر...</asp:ListItem>
                                        </asp:DropDownList>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="ddlCity" InitialValue="-1" ErrorMessage="مطلوب *" CssClass="FieldValidator" ValidationGroup="VgSubmit"></asp:RequiredFieldValidator>
                                    </div>
                                    <div class="col-lg-6">
                                        <label class="control-label"><%=(Master as adminmaster_master).UserSetting.rm.GetString("Station",(Master as adminmaster_master).UserSetting.ci) %> (*)</label>
                                        <asp:TextBox ID="txtName" runat="server" class="form-control" placeholder="المحطة" autofocus="on" AutoCompleteType="Disabled"></asp:TextBox>
                                ...
                                <div class="form-group">
                                    <div class="col-lg-12">
                                        ...
                                        <asp:TextBox ID="txtAddress" runat="server" class="form-control" placeholder="العنوان" autofocus="on" AutoCompleteType="Disabled"></asp:TextBox>
                                        <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtAddress" ErrorMessage="مطلوب *" CssClass="FieldValidator" ValidationGroup="VgSubmit"></asp:RequiredFieldValidator>
                                    </div>
                                </div>
                            </div>
                        </div>
